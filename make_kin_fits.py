...
class kin_map():
    ...
    def generate_blurred_map(self, kernel_size_arc = 0.6/2.35, band = 'H'):
        ...
        if   band == 'H': sens, R = 22.5, 3800 #sens, R = 21.0, 3800
...
#def run_kin_fits(abspath, scale, kmap_name, gal, outdir, arc_per_pixel = 0.2):
    ...
    #for cam_n in arange(ncams):
        ...
        kmap.generate_blurred_map(kernel_size_arc = 0.8/2.35) #jwst
