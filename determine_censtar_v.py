...
if __name__ == "__main__":
    ...
    out_cat = open('/nobackupp2/rcsimons/catalogs/recenter%s'%simname, 'w+')
    ...
    for i in arange(len(new_snapfiles)):
        ...
        if float(anames[i]) > 0.2:
            ...
            cen_x, cen_y, cen_z, cen_vx, ven_vy, cen_vz, cen_star_offset_x, cen_star_offset_y, cen_star_offset_z, cen_star_voffset_x, cen_star_voffset_y, cen_star_voffset_z  = determine_center(new_snapfiles[i], nir_cat_new)
